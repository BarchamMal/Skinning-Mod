...
echo "-------------------------------------Carcases-------------------------------------"
python3 src/main/resources/data/tsm/loot_tables/auto/loot_table_generater.py src/main/resources/data/tsm/loot_tables/auto/loot_tables.yaml src/main/resources/data/tsm/loot_tables/carcases
